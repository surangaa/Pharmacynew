...
function init() {
  ...
  $("#colorSettingsGrid").kendoGrid({
    ...
    rowTemplate: '<tr role="row"><td role="gridcell"><a class="k-button k-button-icontext k-grid-Edit" href=""><span class=" fa fa-pencil"></span></a></td><td role="gridcell">#: Key #</td><td role="gridcell"><div style="width: 40px; height: 20px; background: #: Value #;"></div></td><td role="gridcell">#:Description #</td></tr>'
  });
}
